...
var prev_color = document.createElement('div');
...
//erasing a pixel
function erase_pixel(pixel) {
    pixel.style.backgroundColor = initial_colors.get(pixel);
}
function bucketFill(clickedDiv) {
        ...
        if (!visitedDivs.has(div)) {
            ...
            if (div.style.backgroundColor === clickedColor) {
                ...
                if (topDiv)
                    fillAdjacent(topDiv);
                if (bottomDiv)
                    fillAdjacent(bottomDiv);
                if (leftDiv)
                    fillAdjacent(leftDiv);
                if (rightDiv)
                    fillAdjacent(rightDiv);
            }
